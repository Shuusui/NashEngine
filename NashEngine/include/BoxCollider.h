...
namespace Nash
{
	...
	public: 
		...
		BoxCollider() = delete; 
		BoxCollider(const FVector3& globalPosition, const FVector3& localPosition, const FVector3& bounds = FVector3(1,1,1), const bool& isTrigger = false) :ICollider(globalPosition, localPosition, Enums::ColliderType::BoxCollider, isTrigger), m_bounds(bounds) {};
		BoxCollider(const BoxCollider& boxCollider) 
			:ICollider(boxCollider.GlobalPosition()
				, boxCollider.LocalPosition()
				, Enums::ColliderType::BoxCollider
